...
class ListViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun refresh() {
//        kostLiveData.value = arrayListOf(
//            Kost("Kost Han Tipe A1","Tenggilis Mejoyo","K.Mandi Dalam, AC, Kasur, Kloset Duduk",
//                1000000, "https://static.mamikos.com/uploads/cache/data/style/2018-02-22/E5P3kgip-540x720.jpg"),
//            Kost("Kost Rungkut Agung","Rungkut Mejoyo Selatan","K.Mandi Dalam, AC, Kasur, Wifi",
